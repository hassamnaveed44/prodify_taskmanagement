...
export default function Sidebar({ onClose }: SidebarProps) {
  ...
  return (
    <aside className="w-64 border-r border-slate-100 bg-white flex flex-col h-full py-4 px-5 justify-between select-none overflow-hidden shrink-0">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex items-center justify-between p-2 hover:bg-slate-50 rounded-2xl cursor-pointer transition-colors border border-slate-100/50 shadow-xs bg-slate-50/20">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h4 className="font-extrabold text-slate-800 text-[11px] leading-tight tracking-tight">Hassam Naveed</h4>
        ...
        {/* 2. Main Navigation Links (Compact padding) */}
        ...
        <div className="space-y-1.5">
          <div className="px-3 flex items-center justify-between text-[11px] font-bold text-slate-400 tracking-wider mb-1 select-none">
            ...
            <button className="text-indigo-650 hover:text-indigo-850 transition-colors p-0.5 rounded flex items-center gap-0.5 text-[10px] font-bold normal-case select-none">
        ...
        {/* 4. Settings Link (Positioned directly below Projects list) */}
        <div>
          <Link
            href="/settings"
            onClick={handleLinkClick}
      ...
      {/* 5. Pinned Invite Card (Bottom-most, compact height) */}
      <div className="pt-2">
